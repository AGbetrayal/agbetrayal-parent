...
import com.ag.core.data.jpa.convert.QueryByExamplePredicateBuilder;
import com.ag.core.data.jpa.query.ConditionQueryModel;
import com.ag.core.data.jpa.type.TypeFactory;
...
public class BaseSimpleJpaRepository<T extends Persistable<ID>, ID extends Serializable> implements JpaRepositoryImplementation<T, ID>, BaseJpaRepository<T, ID> {
    ...
    private com.ag.core.data.jpa.repository.support.QueryHints getQueryHints() {
        return metadata == null ? com.ag.core.data.jpa.repository.support.QueryHints.NoHints.INSTANCE : com.ag.core.data.jpa.repository.support.DefaultQueryHints.of(entityInformation, metadata);
    }
    ...
    public QueryPage<T> queryForPage(ConditionQueryModel queryModel) {
        ...
        List<query.Order> orders1 = queryModel.getOrders();
