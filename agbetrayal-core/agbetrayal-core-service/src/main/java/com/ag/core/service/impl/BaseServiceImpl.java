package com.ag.core.service.impl;
...
import com.ag.core.service.security.SecurityContext;
import com.ag.core.service.security.UserPrincipal;
...
public abstract class BaseServiceImpl<T extends Persistable<ID>, ID extends Serializable> implements BaseService<T, ID> {
    ...
    protected final UserPrincipal getPrincipal() {
        return StringUtils.isEmpty(securityContext)? new UserPrincipal(): securityContext.getPrincipal();
    }
